			...
			>
				...
				>
					...
					{chart.data.map((d, i) => {
						...
						return (
							<div key={`${d.month}-${i}`} style={{position: "absolute", left: x, top: 0}}>
								<div
									style={{
										position: "absolute",
										left: 0,
								...
								<div
									style={{
										...
										opacity: interpolate(frame, [baseDelay + i * stagger + 8, baseDelay + i * stagger + 18], [0, 1], {
											extrapolateLeft: "clamp",
											extrapolateRight: "clamp",
										}),
				...
				<div
					style={{
						...
						padding: `${Math.max(10, Math.round(height * 0.012))}px ${Math.max(14, Math.round(width * 0.016))}px`,
						borderRadius: 999,
						border: "1px solid rgba(255,211,106,0.35)",
						background: "linear-gradient(135deg, rgba(255,178,0,0.18), rgba(245,247,255,0.04))",
						color: TEXT,
						fontWeight: 800,
